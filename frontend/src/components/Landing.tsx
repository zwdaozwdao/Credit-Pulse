    ...
    <div className="flex-grow flex flex-col items-center justify-start px-6 pt-16 pb-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full text-center space-y-10 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
          ...
          <a href="https://github.com/zwdaozwdao/Credit-Pulse" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-900 hover:text-slate-900 font-medium transition-colors border-b border-transparent hover:border-slate-900 pb-0.5">
